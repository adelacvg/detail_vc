...
if __name__ == "__main__":
    ...
    parser.add_argument("--source_dir", type=str, default="./44k", help="path to source dir")
    ...
    for speaker in tqdm(os.listdir(args.source_dir)):
        ...
        for file_name in os.listdir(os.path.join(args.source_dir, speaker)):
            ...
            if dur < 0.3 or dur > 15:
                logger.info(f'DUR:{dur}')
                logger.info("Skip too short or too long audio: " + file_path)
                continue
